...
function UserItem({ userId, name,avatar,online, isTyping,lastMsgId, lastMsgText,lastMsgSender,lastMsgTime,loggedInUserId,
  selectChat,}) {
  return (
    <div
    ...
    >
      <div className="relative w-12 h-12">
        <img
          src={avatar ?? "https://ncetir.com/Images/login@4x.png"}
